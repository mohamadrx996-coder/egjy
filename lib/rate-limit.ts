...
export const RATE_LIMITS = {
  ...
  /** كويستات — الجولات التلقائية + جلب/تسجيل متكرر يحتاج سماحة (الجولة الواحدة كل ~55 ثانية عادي جداً) */
  quests: { maxRequests: 40, windowMs: 60000, burstLimit: 15, cooldownMs: 6000 },
  /** افتراضي */
